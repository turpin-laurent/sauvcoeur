...
export const alt         = 'SauvCœur.re — La cause animale à La Réunion'
export const size        = { width: 1200, height: 630 }
export const contentType = 'image/png'

// Image OG par défaut pour la page d'accueil et les pages sans OG spécifique
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 1 }}>
          ...
          <div style={{
            marginTop: 16, color: '#a7f3d0', fontSize: 28,
            textAlign: 'center', maxWidth: 780, lineHeight: 1.4,
          }}>
        ...
        <div style={{
          ...
          padding: '8px 20px', color: 'rgba(255,255,255,0.8)',
